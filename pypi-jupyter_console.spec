...
Version  : 6.4.2
Release  : 50
URL      : https://files.pythonhosted.org/packages/27/bc/97635cf13369cae7bda2fb250f756ec2a9070919d1dcc2bebe9763613e85/jupyter_console-6.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/27/bc/97635cf13369cae7bda2fb250f756ec2a9070919d1dcc2bebe9763613e85/jupyter_console-6.4.2.tar.gz
...
%prep
%setup -q -n jupyter_console-6.4.2
cd %{_builddir}/jupyter_console-6.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646592552
...
cp %{_builddir}/jupyter_console-6.4.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_console/4864371bd27fe802d84990e2a5ee0d60bb29e944
