...
Source0  : https://files.pythonhosted.org/packages/34/5f/3746b1995e95afff0e3b135d53b9dc38486ee05ebfe3bf61bcb23ba64cfa/jupyter_console-6.5.0.tar.gz
...
%prep
%setup -q -n jupyter_console-6.5.0
cd %{_builddir}/jupyter_console-6.5.0
pushd ..
cp -a jupyter_console-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676044736
